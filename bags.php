...
<body>
	...
	<main id="bot">
		...
		<div class="banner">
			...
			<?php
			$records = mysqli_query($conn, "select * from bannerupdate order by `addedon` DESC");
		...
		<div class="catalogue">
			<h2>Available Bag Products</h2>

			<div class="showcase-imgs">
				<!--FETCHING IMAGES FROM DATABSE-->
				<?php
				$records = mysqli_query($conn, "select * from bags");
				while ($data = mysqli_fetch_array($records)) {
				?>
				<!--FETCHING IMAGES FROM DB-->
				<div class="product">
