...
<head>
	...
	<title>Wenongs-children wears</title>
</head>
...
<body>
	...
	<main id="bot">
		...
		<div class="catalogue">
			<h2>Available Children Products</h2>

			<div class="showcase-imgs">
				<!--FETCHING IMAGES FROM DATABSE-->
				<?php
				$records = mysqli_query($conn, "select * from children order by `addedon` DESC");
				while ($data = mysqli_fetch_array($records)) {
				?>
				<!--FETCHING IMAGES FROM DB-->
				<div class="product">
